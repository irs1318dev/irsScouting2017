import server.model.dimension as smd


def test_build_dicts():
    # Dates
    dates, date_ids = smd.build_dicts("dates")
    ...
    # Levels
    levels, level_ids = smd.build_dicts("levels")
    ...
    # Task Options
    tasks_options, task_option_ids = smd.build_dicts("task_options")
